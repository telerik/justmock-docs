...
#### Example 1: Create and Arrange with Mock.Create and Mock.Arrange__
```C#
[TestMethod]
...
> When you need to use argument matchers and the type you need is not present in the [Arg](https://docs.telerik.com/devtools/justmock/api/Telerik.JustMock.Arg.html).Any~ properties, you can also use a custom type by matching it using the `Arg.IsAny<T>()` method.
