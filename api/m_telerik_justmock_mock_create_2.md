---
title: Create Method (String, Behavior)
page_title: Create Method (String, Behavior) | JustMock Documentation
description: Documentation page about Create Method (String, Behavior).
previous_url: /m_telerik_justmock_mock_create_2.html
slug: m_telerik_justmock_mock_create_2
published: True
fullPath: api/n_telerik_justmock/t_telerik_justmock_mock/methods_t_telerik_justmock_mock/overload_telerik_justmock_mock_create/m_telerik_justmock_mock_create_2
category: "api"
---

# Mock.Create Method (String, Behavior)
