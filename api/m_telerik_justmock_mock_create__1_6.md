---
title: Create(T) Method (Behavior, Object[])
page_title: Create(T) Method (Behavior, Object[]) | JustMock Documentation
description: Documentation page about Create(T) Method (Behavior, Object[]).
previous_url: /m_telerik_justmock_mock_create__1_6.html
slug: m_telerik_justmock_mock_create__1_6
published: True
fullPath: api/n_telerik_justmock/t_telerik_justmock_mock/methods_t_telerik_justmock_mock/overload_telerik_justmock_mock_create/m_telerik_justmock_mock_create__1_6
category: "api"
---

# Mock.Create&lt;T&gt;Method (Behavior,Object[])
