---
title: Func(T1, T2, T3, T4, T5, T6, TResult) Delegate
page_title: Func(T1, T2, T3, T4, T5, T6, TResult) Delegate | JustMock Documentation
description: Documentation page about Func(T1, T2, T3, T4, T5, T6, TResult) Delegate.
previous_url: /t_telerik_justmock_func_7.html
slug: t_telerik_justmock_func_7
published: True
fullPath: api/n_telerik_justmock/t_telerik_justmock_func_7
category: "api"
---
...
Encapsulates a method that has 6 parameters and returns a value of the type specified byTResultparameter.
...
<span class="keyword">public</span> <span class="keyword">delegate</span> TResult <span class="identifier">Func</span>&lt;T1, T2, T3, T4, T5, T6, TResult&gt;(
...
<span class="keyword">Public</span> <span class="keyword">Delegate</span> <span class="keyword">Function</span> <span class="identifier">Func</span>(<span class="keyword">Of</span> T1, T2, T3, T4, T5, T6, TResult) ( _
