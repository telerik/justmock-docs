---
title: Create Method (Type, Constructor, Behavior)
page_title: Create Method (Type, Constructor, Behavior) | JustMock Documentation
description: Documentation page about Create Method (Type, Constructor, Behavior).
previous_url: /m_telerik_justmock_mock_create_8.html
slug: m_telerik_justmock_mock_create_8
published: True
fullPath: api/n_telerik_justmock/t_telerik_justmock_mock/methods_t_telerik_justmock_mock/overload_telerik_justmock_mock_create/m_telerik_justmock_mock_create_8
category: "api"
---

# Mock.Create Method (Type, Constructor, Behavior)
