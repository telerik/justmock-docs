---
title: Action(T1, T2, T3, T4, T5, T6, T7) Delegate
page_title: Action(T1, T2, T3, T4, T5, T6, T7) Delegate | JustMock Documentation
description: Documentation page about Action(T1, T2, T3, T4, T5, T6, T7) Delegate.
previous_url: /t_telerik_justmock_action_7.html
slug: t_telerik_justmock_action_7
published: True
fullPath: api/n_telerik_justmock/t_telerik_justmock_action_7
category: "api"
---
...
<span class="keyword">public</span> <span class="keyword">delegate</span> <span class="keyword">void</span> <span class="identifier">Action</span>&lt;T1, T2, T3, T4, T5, T6, T7&gt;(
...
<span class="keyword">Public</span> <span class="keyword">Delegate</span> <span class="keyword">Sub</span> <span class="identifier">Action</span>(<span class="keyword">Of</span> T1, T2, T3, T4, T5, T6, T7) ( _
