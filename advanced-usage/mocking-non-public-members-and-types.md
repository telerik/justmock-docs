...
> **Important**
>
> To mock non-public members and types, you first need to go to elevated mode by enabling JustMock from the menu. Learn how to do that in the [How to Enable/Disable Telerik JustMock](../advanced-usage#how-to-enable-disable-telerik-justmock) topic.
